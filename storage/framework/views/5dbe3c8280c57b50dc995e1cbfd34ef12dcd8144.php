...
<?php $__env->startSection('judul','Tambah Jurnal Penyesuaian - Sistem Informasi Akuntansi'); ?>
                ...
                <div class="card shadow h-100">
                    <div class="card-header border-0">
                        <div class="d-flex flex-column flex-md-row align-items-center justify-content-center justify-content-md-between text-center text-md-left">
                            ...
                            <div class="mb-3">
                                <a href="<?php echo e(route("jurnal-penyesuaian.index")); ?>?page=<?php echo e(request('page')); ?>" class="btn btn-success" data-toggle="tooltip" title="Kembali"><i class="fas fa-arrow-left"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
...
<div class="container-fluid mt--7">
    <div class="card bg-secondary shadow h-100">
        <div class="card-body">
            <form autocomplete="off" action="<?php echo e(route('jurnal-penyesuaian.store')); ?>" method="post" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\X441N\Documents\denada_akun\akuntansi\resources\views/jurnal-penyesuaian/create.blade.php ENDPATH**/ ?>